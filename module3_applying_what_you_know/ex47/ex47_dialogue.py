DIALOGUE = {
    "CentralCorridor_enter": """The Gothons of Planet Percal #25 have invaded your ship and
...
""",
    "CentralCorridor_shoot": """Quick on the draw you yank out your blaster and fire it at
...
""",
    "CentralCorridor_dodge": """Like a world class boxer you dodge, weave, slip and slide
...
and eats you.
""",
    "CentralCorridor_joke": """Lucky for you they made you learn Gothon insults in the
...
""",
    "LaserWeaponArmory_enter": """You do a dive roll into the Weapon Armory, crouch and scan
...
code is 3 digits.
""",
    "LaserWeaponArmory_guess": """The container clicks open and the seal breaks, letting gas
out. You grab the neutron bomb and run as fast as you can
to the bridge where you must place it in the right spot.
""",
    "LaserWeaponArmory_fail": """The lock buzzes one last time and then you hear a sickening
melting sound as the mechanism is fused together. You
decide to sit there, and finally the Gothons blow up the
ship from their ship and you die.
""",
    "TheBridge_enter": """You burst onto the Bridge with the neutron destruct bomb
...
""",
    "TheBridge_throw_bomb": """In a panic you throw the bomb at the group of Gothons and
...
""",
    "TheBridge_place_bomb": """You point your blaster at the bomb under your arm and the
...
""",
    "EscapePod_enter": """You rush through the ship desperately trying to make it to
...
""",
    "EscapePod_death": """You jump into pod {guess} and hit the eject button. The pod
escapes out into the void of space, then implodes as the
hull ruptures, crushing your body into jam jelly.
""",
    "EscapePod_escape": """You jump into pod {guess} and hit the eject button. The pod
